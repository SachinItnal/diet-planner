...
# ✅ Configuration
app.config["MONGO_URI"] = os.environ.get("MONGO_URI") or "mongodb+srv://sachin:sachin2001@cluster0.xhz87go.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
def chat():
    ...
    try:
        prompt = f"Answer the following user question in about 30 words:\n\n{user_message}"
