...
class Config:
    ...
    MONGO_URI = os.environ.get("MONGO_URI") or "mongodb+srv://sachin:sachin2001@cluster0.xhz87go.mongodb.net/diet_planner?retryWrites=true&w=majority&appName=Cluster0"
